        ...
        <section className="grid gap-6 lg:grid-cols-[340px_1fr]">
          ...
          <div className="card p-6">
            ...
            <div className="mb-6 flex flex-col items-center text-center">
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 to-emerald-600 text-3xl font-bold text-white shadow-lg">
              ...
              {details.rfidCardLast4 && (
                <span className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-teal-50 px-3 py-1 text-xs font-semibold text-teal-700 ring-1 ring-teal-200">
