...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-brand-100 via-brand-50 to-brand-200 px-4 text-slate-900">
      <img src={schoolLogo} alt="TFC" className="mb-6 h-20 w-20 rounded-2xl object-contain ring-1 ring-brand-100" />
      ...
      <p className="mt-2 text-sm text-brand-700">This page doesn't exist in the TFC platform.</p>
