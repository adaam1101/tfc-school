              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-xs text-slate-500">
                    <a href={`tel:${e.phone}`} className="flex items-center gap-1 hover:text-teal-700"><Phone className="h-3 w-3" />{e.phone}</a>
                    {e.email && <a href={`mailto:${e.email}`} className="flex items-center gap-1 hover:text-teal-700"><Mail className="h-3 w-3" />{e.email}</a>}
