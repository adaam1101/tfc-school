...
export default function DigitalReceiptModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/75 backdrop-blur-sm p-3 sm:p-6 overflow-y-auto print:p-0 print:bg-white animate-fade-in">
      <div className="w-full max-w-lg rounded-3xl bg-white dark:bg-slate-900 shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-800 print:border-0 print:shadow-none my-4 sm:my-8">
